...
size_t UtilitySerializator::serialize(std::ostream &os, const std::vector<Action>& value) {
    const auto pos = os.tellp();
...
std::pair<size_t, std::vector<Action>> UtilitySerializator::deserialize_action_vec(std::istream& is) {
